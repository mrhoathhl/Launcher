package com.simcoder.novalauncherclone.model;
...
public class SongModel implements Serializable, Comparable<SongModel> {
    ...
    public SongModel(long id, String title, String file_name, String artist, String album, String duration) {
        this.id = id;
        this.title = title;
    ...
    @Override
    public int compareTo(SongModel song) {
